...
const fallbackImageMap: ImageMap = {
  ...
  "Sinergia Cuba - ERP SaaS multi-tenant para MiPyMEs cubanas": erpCubaImg,
  "Sinergia Cuba - Multi-tenant SaaS ERP for Cuban SMEs": erpCubaImg,
  ...
  "Termal Print Pro (MVP) - Sistema SaaS de Etiquetas Térmicas para Alimentos y Retail": termalImg,
  ...
  "RopaStore — E-commerce de Moda": ropastoreImg,
