...
const fallbackImageMap: ImageMap = {
  ...
  "Clavisoft - Plataforma de Servicios de Software": encantShopImg,
  "Clavisoft - Software Services Platform": encantShopImg,
  "Gaby's Prints - Tienda de Impresiones Personalizadas": encantShopImg,
  "Gaby's Prints - Custom Printing Shop": encantShopImg,
  "Encant Shop - Catálogo de Accesorios": encantShopImg,
  "Encant Shop - Accessories Catalog": encantShopImg,
  "Gaby Shop - Tienda Online de Productos": encantShopImg,
  "Gaby Shop - Online Product Store": encantShopImg,
  "OSINT Terminal - Herramienta de Inteligencia de Fuentes Abiertas": websecImg,
  "OSINT Terminal - Open Source Intelligence Tool": websecImg,
